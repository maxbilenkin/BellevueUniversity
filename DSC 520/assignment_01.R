# Assignment: ASSIGNMENT 1 (2.2 Exercise)
# Name: Bilenkin, Maxim
# Date: 2024-12-03
...
result <- total_sleep_week1 < total_sleep_week2
print(result)

## Calculate the mean hours slept in week 1 using the `mean()` function
week1_mean_hours_slept <- mean(week1_sleep)
print(week1_mean_hours_slept)

## Create a vector called `days` containing the days of the week.
## Start with Sunday and end with Saturday
days <- c("Sunday", "Monday", "Tuesday", "Wednsday", "Thursday", "Friday", "Saturday")
print(days)
...
amount_Of_sleep_On_Tuesday_week1 <- week1_sleep["Tuesday"]
print(amount_Of_sleep_On_Tuesday_week1)
...
is_weekdays1_greater <- weekdays1_mean > weekdays2_mean
print(is_weekdays1_greater)
    
## Determine how many days in week 1 had over 8 hours of sleep using the `>` operator
over8_hours_in_week1 <- sum(week1_sleep > 8)
print(over8_hours_in_week1)
...
rownames(grades) <- c("student01", "student02", "student03")
colnames(grades) <- c("Score1","Score2")
print(grades)
